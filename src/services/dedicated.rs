...
use crate::models::{
    ApiResponse,
    dedicated::{
        DedicatedServerAction, DedicatedServerDetails, DedicatedServerHardwareComponent,
        DedicatedServerOsTemplate, DedicatedServerReinstallData, DedicatedServerReinstallStatus,
        DedicatedServerTask,
    },
};
...
impl DedicatedServerApiService {
    ...
    pub async fn perform_action(
        ...
        self.client
            .send_request(
                Method::POST,
                &format!("/services/{}/dedicated/action", id),
                Some(body),
            )
            .await
    }
    ...
    pub async fn get_details(
        ...
        self.client
            .send_request(
                Method::GET,
                &format!("/services/{}/dedicated/info", id),
                None,
            )
            .await
    }
    ...
    pub async fn get_hardware_components(
        ...
        self.client
            .send_request(
                Method::GET,
                &format!("/services/{}/dedicated/hardware", id),
                None,
            )
            .await
    }
    ...
    pub async fn get_os_templates(
        ...
        self.client
            .send_request(
                Method::GET,
                &format!("/services/{}/dedicated/os-templates", id),
                None,
            )
            .await
    }
    ...
    pub async fn get_reinstall_status(
        ...
        self.client
            .send_request(
                Method::GET,
                &format!("/services/{}/dedicated/reinstall-status", id),
                None,
            )
            .await
    }
    ...
    pub async fn reinstall(
        ...
        self.client
            .send_request(
                Method::POST,
                &format!("/services/{}/dedicated/reinstall", id),
                body,
            )
            .await
    }
    ...
    pub async fn get_tasks(
        ...
        self.client
            .send_request(
                Method::GET,
                &format!("/services/{}/dedicated/tasks", id),
                None,
            )
            .await
    }
